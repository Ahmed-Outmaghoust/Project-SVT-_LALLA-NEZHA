...
function setTheme(mode){
  ...
  localStorage.setItem("cancer_theme", mode);
  if(themeBtn) themeBtn.textContent = mode === "light" ? "🌙 Mode sombre" : "☀️ Mode clair";
}
setTheme(localStorage.getItem("cancer_theme") || "dark");
...
const modalData = {
  chirurgie: {
    ...
    body: `
      ...
      <ul>
        ...
        <li>Souvent combinée avec d’autres traitements.</li>
      </ul>
    `
  },
  radio: {
    ...
    body: `
      ...
      <ul>
        <li>Traitement local sur une zone.</li>
  ...
  chimio: {
    ...
    body: `
      ...
      <ul>
        <li>Peut provoquer fatigue, baisse d’immunité, chute de cheveux.</li>
        <li>Objectif : détruire plus de cellules tumorales que saines.</li>
      </ul>
    `
  },
  ciblee: {
    ...
    body: `
      <p><strong>Principe :</strong> viser une protéine / mutation spécifique de la tumeur.</p>
      <ul>
        <li>Souvent plus “précis” que certaines chimios.</li>
        <li>Nécessite connaître le profil de la tumeur.</li>
      </ul>
    `
  },
  immuno: {
    ...
    body: `
      <p><strong>Principe :</strong> aider le système immunitaire à reconnaître et attaquer la tumeur.</p>
      <ul>
  ...
  schema: {
    title: "Schéma : ADN → Cancer",
    body: `
      <div style="display:grid; gap:10px;">
        <div style="padding:12px;border:1px solid var(--border);border-radius:16px;background:var(--card)">
          <strong>ADN</strong> → <strong>gènes</strong> → <strong>protéines</strong>
        </div>
        <div style="padding:12px;border:1px solid var(--border);border-radius:16px;background:var(--card)">
          Mutations sur gènes du <strong>cycle cellulaire</strong> :
          freins cassés / accélérateurs bloqués → <strong>division incontrôlée</strong>
        </div>
        <div style="padding:12px;border:1px solid var(--border);border-radius:16px;background:var(--card)">
...
const quiz = [
  ...
  },
  {
    ...
    a: [
      ...
      "La propagation vers d’autres organes",
  ...
  {
    q: "Pourquoi ne peut-on pas stopper toutes les divisions cellulaires ?",
    a: [
      "Parce que certains tissus se renouvellent (peau, sang, intestin)",
  ...
  },
  {
    ...
    a: [
      "Remplacer le sang",
      "Aider l’immunité à attaquer la tumeur",
      "Augmenter les UV",
      "Arrêter le cœur"
    ],
    correct: 1
